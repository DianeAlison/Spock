...
DROP TABLE  #temp3
DROP TABLE  adhoc.dbo.PCR_monthly_data


DECLARE		@start_date datetime,
			@end_date datetime

SET			@start_date = '01/01/2020'   -- change this date only at the beginning of a new year.  Bump the start_date up by one year.    
SET			@end_date	= '02/28/2021'  -- Change the end_date to the month end date for the previous month
...
INTO	adhoc.dbo.PCR_monthly_data
...
FROM	adhoc.dbo.PCR_monthly_data
